...
#ifndef DOPUSMAC_SWIFT_H
#define DOPUSMAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DOpusMac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8DOpusMac11AppDelegate")
...
SWIFT_CLASS("_TtC8DOpusMac20QuickLookCoordinator")
@interface QuickLookCoordinator : NSObject <QLPreviewPanelDataSource>
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC8DOpusMac19RowMouseEventNSView")
@interface RowMouseEventNSView : NSView
...
@interface RowMouseEventNSView (SWIFT_EXTENSION(DOpusMac)) <NSDraggingSource>
- (BOOL)ignoreModifierKeysForDraggingSession:(NSDraggingSession * _Nonnull)session SWIFT_WARN_UNUSED_RESULT;
